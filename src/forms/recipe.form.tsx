...
// если создаем новый рецепт, а не редактируем существующий
const initialState = {
  name: "",
  description: "",
  imageUrl: ""
...
// Форма для редактирования (принимает в себя рецепт initialRecipe) и создания нового рецепта
const RecipeForm = ({ initialRecipe }: RecipeFormProps) => {
  ...
  // состояние полей ингредиентов (до 10 на рецепт)
  ...
  // лоадинг кнопки сабмит
  const [isPending, startTransition] = useTransition();

  // nextJS хук для навигации, изменения текущего url
